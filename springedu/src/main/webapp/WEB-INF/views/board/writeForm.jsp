...
<ul>
  ...
  <li><label for="btitle">제목</label><input type="text" name="btitle" id="btitle"></li>
  <li><label for="bid">작성자</label><input type="text" name="bid" id="bid"></li>
  <li><label for="bcontent">내용</label><textarea name="bcontent" id="bcontent" cols="30" rows="10"></textarea></li>
  <li><label for="">첨부</label>
